...
@Embeddable
public class IdAjouterFavoris implements Serializable {
    ...
    public IdAjouterFavoris() {
    }

    public IdAjouterFavoris(Long idUtilisateur,
                            Long idEvenement) {
    ...
    public boolean equals(Object o) {
        ...
        IdAjouterFavoris that = (IdAjouterFavoris) o;
